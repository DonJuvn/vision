...
from predict_utils import load_model, CLASS_COLORS
...
def main():
    ...
    # Попытка открыть камеру с обработкой ошибок
    ...
    while True:
        try:
            ...
            print(f"[ERROR] Ошибка при обработке кадра: {str(e)}")
            # Продолжаем работу despite ошибки
            continue
